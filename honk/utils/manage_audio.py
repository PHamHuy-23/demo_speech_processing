...
class AudioSnippet(object):
    ...
    def chunk_phonemes(self, factor=1.0, group_threshold=1000):
        ...
        data = librosa.feature.melspectrogram(y=audio_data, sr=16000, n_mels=40, hop_length=160, n_fft=480, fmin=20, fmax=4000)
        data[data > 0] = np.log(data[data > 0])
...
class AudioSnippetGenerator(object):
    def __init__(self, sr=16000, fmt=8, chunk_size=1024, channels=1):
        self.sr = sr
        self.fmt = fmt
